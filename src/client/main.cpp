            ...
            else
            {
                ...
                else
                {
                    ...
                    else //登陆成功
                    {
                        ...
                        static int readThreadNumer = 0;
                        if(readThreadNumer == 0)
                        {
                            std::thread readTask(readTaskHandler, clientfd); //底层调用了pthread_create
                            readTask.detach();                               //底层调用了pthread_detach
                            readThreadNumer++;
                        }
        ...
        case 2: //注册业务
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        cout << name << " register success,userid is " << responsejs["id"] << " ,do not froget it!" << endl;
                    }
                }
            }
        }
